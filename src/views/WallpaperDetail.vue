...
<template>
    ...
    <div class="flex flex-col py-10 px-2  gap-10   text-[var(--p-content-color)]" v-else>
        <div class="flex xl:flex-row flex-col justify-between gap-10 items-center">
            ...
            <div class="w-full xl:w-auto p-3 md:min-w-140 flex flex-col gap-2 border border-[var(--p-divider-border-color)]  rounded-2xl 
            ">
                <!-- info -->
                <div
